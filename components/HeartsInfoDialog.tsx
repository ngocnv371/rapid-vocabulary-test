...
interface HeartsInfoDialogProps {
  onClose: () => void;
}

const HeartsInfoDialog: React.FC<HeartsInfoDialogProps> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4 animate-fade-in" onClick={onClose}>
      <div className="bg-gray-800 p-8 rounded-2xl shadow-2xl border border-purple-500/30 text-center max-w-md w-full relative" onClick={e => e.stopPropagation()}>
        ...
        <span className="text-7xl mb-4 block" role="img" aria-label="Heart emoji">💖</span>
        <h3 className="text-2xl font-bold text-pink-400 mb-4">Your Learning Hearts!</h3>
        <p className="text-gray-300 mb-6">
          Each time you start a quiz, you use one heart. This encourages a steady and fun learning pace.
        </p>
...
export default HeartsInfoDialog;
