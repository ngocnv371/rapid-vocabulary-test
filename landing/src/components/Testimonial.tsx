      ...
      <div className="container mx-auto max-w-3xl text-center">
        <blockquote className="relative">
          ...
          <p className="text-2xl italic text-gray-200">
            "I've always struggled with learning new words. VocabRush made it an addictive game. My vocabulary has improved more in the last month than it has in years!"
          </p>
